...
<head>
    ...
    <title>Изменить страничку студента</title>
                    ...
                    <form action="/student-modify" method="post">
                        ...
                        <ul class="flex-outer">
                            <li>
                                ...
                                <input type="text" class="input" name="surname" value="${student.surname}">
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <input type="text" class="input" name="group" value="${student.group}">
                            </li>
                            <li>
                                <label class="label">Дата поступления</label>
                                <input type="text" class="input" name="date" id="datepicker" value="<fmt:formatDate pattern="dd/MM/yyyy" value="${student.date}"/>">
                            </li>
                            <li>
