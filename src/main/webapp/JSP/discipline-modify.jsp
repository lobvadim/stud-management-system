...
<head>
    ...
    <title>Модификация странички студента</title>
        ...
        <main>
            <div class="block-text-over-form">
                <div class="text-over-form">
                    <p>Для того, чтобы модифицировать дисциплину введите новое значение поля и нажмите кнопку "Применить"</p>
                </div>
            </div>
                    ...
                    <form action="/discipline-modify" method="post">
                        ...
                        <ul class="flex-outer">
                            <li>
                                ...
                                <input type="text" class="input" name="disciplineName" value="${discipline.discipline}">
                            </li>
